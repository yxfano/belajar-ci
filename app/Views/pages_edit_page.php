                        ...
                        <div class="col-sm-9">
                            ...
                            <form action="<?= base_url('admin/pages/update'); ?>" method="POST">
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="judulhalaman" class="form-control" id="judul" placeholder="Masukkan Nama"
                                    value="<?= $hal['judul'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                 ...
                                 <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="isihalaman" class="form-control" id="isi" placeholder="Masukkan Nomor Contact"
                                    value="<?= $hal['isi'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                    <button type="submit" id="send_form" class="btn btn-success">Submit</button>
                                    <a href="<?= base_url('admin/pages/page')?>" class="btn btn-danger">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
