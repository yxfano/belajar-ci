                        ...
                        <div class="col-sm-9">
                            ...
                            <form action="<?= base_url('admin/pages/store'); ?>" method="POST">
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="judulhalaman" class="form-control" id="judul" placeholder="Masukkan Judul Halaman">
                                </div>
                                <div class="form-grup">
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="isihalaman" class="form-control" id="isi" placeholder="Masukkan Isi Halaman">
                                </div>
