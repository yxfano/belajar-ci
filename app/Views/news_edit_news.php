                        ...
                        <div class="col-sm-9">
                            ...
                            <form action="<?= base_url('admin/pages/update'); ?>" method="POST">
                                ...
                                <div class="form-grup">
                                    ...
                                    <br>
                                    <input type="text" name="judulberita" class="form-control" id="judul" placeholder="Masukkan Nama"
                                    value="<?= $brt['judul'] ?>">
                                    <br>
                                </div>
                                <div class="form-grup">
                                 ...
                                 <div class="form-grup">
                                    <label for="isi">Foto</label>
                                    <br>
                                    <input type="file" name="isi" class="form-control" id="isi" 
                                    value="<?= $brt['foto'] ?>">
                                    <br>
                                    <div class="form-grup">
