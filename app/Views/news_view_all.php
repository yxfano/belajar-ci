                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <table class="table table-striped" id="tableuser">
                                ...
                                <tbody>
                                    <?php if($master_berita): ?>
                                    <?php foreach ($master_berita as $news): ?>
                                    <tr>
                                        <td><?= $news['idberita']; ?></td>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/news/edit/'.$news['idberita']);?>" class="btn btn-success">Edit</a>
                                            <a href="<?= base_url('admin/news/delete/'.$news['idberita']);?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
